...
<html lang="en">
  ...
  <meta property="fb:app_id" content="1401488693436528">
    ...
    <meta property="og:image" content="https://avatars1.githubusercontent.com/u/2259971?s=400&amp;v=4" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="TomLous/coursera-reproducible-research-peer-assessment1" /><meta property="og:url" content="https://github.com/TomLous/coursera-reproducible-research-peer-assessment1" /><meta property="og:description" content="coursera-reproducible-research-peer-assessment1 - Peer Assessment 1 for Reproducible Research" />

  <link rel="assets" href="https://assets-cdn.github.com/">
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MjgwNzEyMDI4OmIyYjRiZDk5NDU3YTA3ODc3MjA0ZWU0NjM4YWFhZDMyZmMyZGIyNmJiZGZlYTMzNzg4NGY2OTFkZTdjYjlmNTg=--5dbc900517be949936aa0656b04882b60417b229">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="2598:5A64:1414A3F:281EA02:5B0B035F" data-pjax-transient>
...
<meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="2598:5A64:1414A3F:281EA02:5B0B035F" /><meta name="octolytics-dimension-region_edge" content="iad" /><meta name="octolytics-dimension-region_render" content="iad" /><meta name="octolytics-actor-id" content="38840065" /><meta name="octolytics-actor-login" content="jerebai" /><meta name="octolytics-actor-hash" content="e0a6f03a18d7d0695c50a94447faa7c435f6c296c12b1ac572af98d638f136c5" />
<meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="jerebai">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta name="html-safe-nonce" content="f087feecfb2c2b385da0f073ea709b3c92ac073d">
  ...
  <meta name="octolytics-dimension-user_id" content="2259971" /><meta name="octolytics-dimension-user_login" content="TomLous" /><meta name="octolytics-dimension-repository_id" content="23046887" /><meta name="octolytics-dimension-repository_nwo" content="TomLous/coursera-reproducible-research-peer-assessment1" /><meta name="octolytics-dimension-repository_public" content="true" /><meta name="octolytics-dimension-repository_is_fork" content="true" /><meta name="octolytics-dimension-repository_parent_id" content="16709733" /><meta name="octolytics-dimension-repository_parent_nwo" content="rdpeng/RepData_PeerAssessment1" /><meta name="octolytics-dimension-repository_network_root_id" content="16709733" /><meta name="octolytics-dimension-repository_network_root_nwo" content="rdpeng/RepData_PeerAssessment1" /><meta name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" content="false" />
...
<header class="Header  f5" role="banner">
  ...
  <div class="position-relative">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="23046887" data-scoped-search-url="/TomLous/coursera-reproducible-research-peer-assessment1/search" data-unscoped-search-url="/search" action="/TomLous/coursera-reproducible-research-peer-assessment1/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=kur6DzQVGYTijHTf0vnLwSRhyr3HDKwb6Dgtxv+/u0eoi4nI6EjnX0vFF64VSLSVOKlGI6rGjOFXELuXdTA7zA=="
          spellcheck="false"
          autocomplete="off"
          autocapitalize="off"
          >
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown js-menu-container">
    ...
    <a aria-label="You have no unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-hotkey="g n" data-ga-click="Header, go to notifications, icon:read" data-channel="notification-changed:38840065" href="/notifications">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="details-expanded details-reset js-dropdown-details d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@jerebai" class="avatar float-left mr-1" src="https://avatars1.githubusercontent.com/u/38840065?s=40&amp;v=4" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>

      <ul class="dropdown-menu dropdown-menu-sw">
        <li class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">jerebai</strong>
        </li>

        <li class="dropdown-divider"></li>

        <li><a class="dropdown-item" href="/jerebai" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a></li>
        <li><a class="dropdown-item" href="/jerebai?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a></li>
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form class="logout-form" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="nDcV/Aks4kUoNw6b20fqHYFVsu4GCogmUUZYKtoQfiC/hdu6AahFQmv2/2Xdr04WMBB8tATQ8Ii+R8OdRfnxPg==" />
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="sr-only right-0" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="ILWDSE9ypuzMEqKV7eA605UYB4SmTgm+hGgCekrT12wDB00OR/YB64/TU2vrCJ7YJF3J3qSUcRBraZnN1TpYcg==" />
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-autosubmit="true" data-remote="true" class="js-social-container" action="/notifications/subscribe" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="dcUe7DxbKC1M9C6JT6Hbjb7CGWGAqom7fGmdWVS70xjiMGHKQ/5JSbrUl/jYEa8fCiOmKkfoaYMdbsTOux7Zmg==" />      <input type="hidden" name="repository_id" id="repository_id" value="23046887" class="form-control" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="starred js-social-form" action="/TomLous/coursera-reproducible-research-peer-assessment1/unstar" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="o+GW+e8GnDhHfgQQq6YBFWa7RBOl4Vzx+helSQAEb9i36IFKczJZh7C7b4M3cY1CwulbF0L6VKfFCW8nkf2uZQ==" />
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="unstarred js-social-form" action="/TomLous/coursera-reproducible-research-peer-assessment1/star" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="sENFrbGjazjTad8gvJp4foKoeWIT37Zu905I3+D3MMfLv6YM1sg2j4yuSXEHsMMGAL5Uq7IIDe/Ee/zJOzvpvg==" />
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="btn-with-count" action="/TomLous/coursera-reproducible-research-peer-assessment1/fork" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="SdyfK4mGsRyn+W5b2rdLV0diFWQF8Mrc5HlQ5+ZvLcgwqORkSskmXcXMOn5tIwqMBmsQyh/EBZjUv9vsf7xZIw==" />
            <button
                type="submit"
    ...
    <a href="/TomLous/coursera-reproducible-research-peer-assessment1/network" class="social-count"
       aria-label="30216 users forked this repository">
      30,216
    </a>
  </li>
</ul>
...
--><strong itemprop="name"><a data-pjax="#js-repo-pjax-container" href="/TomLous/coursera-reproducible-research-peer-assessment1">coursera-reproducible-research-peer-assessment1</a></strong>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a class="js-selected-navigation-item selected reponav-item" itemprop="url" data-hotkey="g c" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches repo_packages /TomLous/coursera-reproducible-research-peer-assessment1" href="/TomLous/coursera-reproducible-research-peer-assessment1">
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a data-hotkey="g p" itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="repo_pulls checks /TomLous/coursera-reproducible-research-peer-assessment1/pulls" href="/TomLous/coursera-reproducible-research-peer-assessment1/pulls">
    ...
    <a data-hotkey="g b" class="js-selected-navigation-item reponav-item" data-selected-links="repo_projects new_repo_project repo_project /TomLous/coursera-reproducible-research-peer-assessment1/projects" href="/TomLous/coursera-reproducible-research-peer-assessment1/projects">
      <svg class="octicon octicon-project" viewBox="0 0 15 16" version="1.1" width="15" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M10 12h3V2h-3v10zm-4-2h3V2H6v8zm-4 4h3V2H2v12zm-1 1h13V1H1v14zM14 0H1a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h13a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1z"/></svg>
      Projects
      <span class="Counter" >0</span>
</a>
    <a class="js-selected-navigation-item reponav-item" data-hotkey="g w" data-selected-links="repo_wiki /TomLous/coursera-reproducible-research-peer-assessment1/wiki" href="/TomLous/coursera-reproducible-research-peer-assessment1/wiki">
      <svg class="octicon octicon-book" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M3 5h4v1H3V5zm0 3h4V7H3v1zm0 2h4V9H3v1zm11-5h-4v1h4V5zm0 2h-4v1h4V7zm0 2h-4v1h4V9zm2-6v9c0 .55-.45 1-1 1H9.5l-1 1-1-1H2c-.55 0-1-.45-1-1V3c0-.55.45-1 1-1h5.5l1 1 1-1H15c.55 0 1 .45 1 1zm-8 .5L7.5 3H2v9h6V3.5zm7-.5H9.5l-.5.5V12h6V3z"/></svg>
      Wiki
</a>

  <a class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors dependency_graph pulse /TomLous/coursera-reproducible-research-peer-assessment1/pulse" href="/TomLous/coursera-reproducible-research-peer-assessment1/pulse">
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/TomLous/coursera-reproducible-research-peer-assessment1/blob/7cbec62bda80532845818ec319f08f683829ac94/PA1_template.md">Permalink</a>
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="select-menu-modal-holder js-menu-content js-navigation-container" data-pjax>
    ...
    <div id="blob-path" class="breadcrumb">
      <span class="repo-root js-repo-root"><span class="js-path-segment"><a data-pjax="true" href="/TomLous/coursera-reproducible-research-peer-assessment1"><span>coursera-reproducible-research-peer-assessment1</span></a></span></span><span class="separator">/</span><strong class="final-path">PA1_template.md</strong>
    </div>
  </div>


  <include-fragment src="/TomLous/coursera-reproducible-research-peer-assessment1/contributors/master/PA1_template.md" class="commit-tease">
    <div>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a id="raw-url" class="btn btn-sm BtnGroup-item" href="/TomLous/coursera-reproducible-research-peer-assessment1/raw/master/PA1_template.md">Raw</a>
        <a class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b" href="/TomLous/coursera-reproducible-research-peer-assessment1/blame/master/PA1_template.md">Blame</a>
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/TomLous/coursera-reproducible-research-peer-assessment1/commits/master/PA1_template.md">History</a>
    </div>
        ...
        <a class="btn-octicon tooltipped tooltipped-nw"
          ...
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form js-update-url-with-hash" action="/TomLous/coursera-reproducible-research-peer-assessment1/edit/master/PA1_template.md" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="S5P0KRE0EuH8NDibvWBVx5h/vV53ALio5xzX+q2S+uSlF+J2LyuNS2sWb8FNQaIn2j8x1ZW56F3pAsTkyuZFsA==" />
            <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
              aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
              <svg class="octicon octicon-pencil" viewBox="0 0 14 16" version="1.1" width="14" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
            </button>
</form>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form" action="/TomLous/coursera-reproducible-research-peer-assessment1/delete/master/PA1_template.md" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="U7Z3WiXtk/KJRJyXVjBEitvD6cf0pRVWUvE6Fb8STRL4bk/tmA1EWh9su/dRcYQp+Wu5BEF3DN2gb3WygHhQcg==" />
...
<h5><a id="user-content-1-load-the-data-ie-readcsv" class="anchor" aria-hidden="true" href="#1-load-the-data-ie-readcsv"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>1. Load the data (i.e. read.csv())</h5>
...
<h5><a id="user-content-2-processtransform-the-data-if-necessary-into-a-format-suitable-for-your-analysis" class="anchor" aria-hidden="true" href="#2-processtransform-the-data-if-necessary-into-a-format-suitable-for-your-analysis"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>2. Process/transform the data (if necessary) into a format suitable for your analysis</h5>
...
<h5><a id="user-content-1-make-a-histogram-of-the-total-number-of-steps-taken-each-day" class="anchor" aria-hidden="true" href="#1-make-a-histogram-of-the-total-number-of-steps-taken-each-day"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>1. Make a histogram of the total number of steps taken each day</h5>
...
<p><a target="_blank" href="/TomLous/coursera-reproducible-research-peer-assessment1/blob/master/figure/unnamed-chunk-5.png"><img src="/TomLous/coursera-reproducible-research-peer-assessment1/raw/master/figure/unnamed-chunk-5.png" alt="plot of chunk unnamed-chunk-5" style="max-width:100%;"></a></p>
<h5><a id="user-content-2-calculate-and-report-the-mean-and-median-total-number-of-steps-taken-per-day" class="anchor" aria-hidden="true" href="#2-calculate-and-report-the-mean-and-median-total-number-of-steps-taken-per-day"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>2. Calculate and report the mean and median total number of steps taken per day</h5>
...
<p><a target="_blank" href="/TomLous/coursera-reproducible-research-peer-assessment1/blob/master/figure/unnamed-chunk-8.png"><img src="/TomLous/coursera-reproducible-research-peer-assessment1/raw/master/figure/unnamed-chunk-8.png" alt="plot of chunk unnamed-chunk-8" style="max-width:100%;"></a></p>
<h5><a id="user-content-2-which-5-minute-interval-on-average-across-all-the-days-in-the-dataset-contains-the-maximum-number-of-steps" class="anchor" aria-hidden="true" href="#2-which-5-minute-interval-on-average-across-all-the-days-in-the-dataset-contains-the-maximum-number-of-steps"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>2. Which 5-minute interval, on average across all the days in the dataset, contains the maximum number of steps?</h5>
...
<h5><a id="user-content-1-calculate-and-report-the-total-number-of-missing-values-in-the-dataset" class="anchor" aria-hidden="true" href="#1-calculate-and-report-the-total-number-of-missing-values-in-the-dataset"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>1. Calculate and report the total number of missing values in the dataset</h5>
...
<h5><a id="user-content-2-devise-a-strategy-for-filling-in-all-of-the-missing-values-in-the-dataset" class="anchor" aria-hidden="true" href="#2-devise-a-strategy-for-filling-in-all-of-the-missing-values-in-the-dataset"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>2. Devise a strategy for filling in all of the missing values in the dataset.</h5>
<h5><a id="user-content-3-create-a-new-dataset-that-is-equal-to-the-original-dataset-but-with-the-missing-data-filled-in" class="anchor" aria-hidden="true" href="#3-create-a-new-dataset-that-is-equal-to-the-original-dataset-but-with-the-missing-data-filled-in"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>3. Create a new dataset that is equal to the original dataset but with the missing data filled in.</h5>
...
<h5><a id="user-content-4-make-a-histogram-of-the-total-number-of-steps-taken-each-day" class="anchor" aria-hidden="true" href="#4-make-a-histogram-of-the-total-number-of-steps-taken-each-day"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>4. Make a histogram of the total number of steps taken each day</h5>
...
<p><a target="_blank" href="/TomLous/coursera-reproducible-research-peer-assessment1/blob/master/figure/unnamed-chunk-12.png"><img src="/TomLous/coursera-reproducible-research-peer-assessment1/raw/master/figure/unnamed-chunk-12.png" alt="plot of chunk unnamed-chunk-12" style="max-width:100%;"></a></p>
<h5><a id="user-content--and-calculate-and-report-the-mean-and-median-total-number-of-steps-taken-per-day" class="anchor" aria-hidden="true" href="#-and-calculate-and-report-the-mean-and-median-total-number-of-steps-taken-per-day"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>... and Calculate and report the mean and median total number of steps taken per day.</h5>
...
<h5><a id="user-content-1-create-a-new-factor-variable-in-the-dataset-with-two-levels--weekday-and-weekend-indicating-whether-a-given-date-is-a-weekday-or-weekend-day" class="anchor" aria-hidden="true" href="#1-create-a-new-factor-variable-in-the-dataset-with-two-levels--weekday-and-weekend-indicating-whether-a-given-date-is-a-weekday-or-weekend-day"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>1. Create a new factor variable in the dataset with two levels – “weekday” and “weekend” indicating whether a given date is a weekday or weekend day.</h5>
...
<p><a target="_blank" href="/TomLous/coursera-reproducible-research-peer-assessment1/blob/master/figure/unnamed-chunk-15.png"><img src="/TomLous/coursera-reproducible-research-peer-assessment1/raw/master/figure/unnamed-chunk-15.png" alt="plot of chunk unnamed-chunk-15" style="max-width:100%;"></a></p>
</article>
  </div>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.33092s from unicorn-4027468098-lfb93">GitHub</span>, Inc.</li>
